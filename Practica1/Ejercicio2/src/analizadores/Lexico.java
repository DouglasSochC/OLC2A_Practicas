...
"5:9,2,1,5:2,2,5:18,2,5:15,4,3,5:65486,0:2")[0];
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -4:
						break;
					case 4:
						{return new Symbol(sym.NUMERO_UNO,yyline,yychar, yytext());}
					case -5:
						break;
					case 5:
						{return new Symbol(sym.NUMERO_CERO,yyline,yychar, yytext());}
					case -6:
						break;
					case 6:
						{
